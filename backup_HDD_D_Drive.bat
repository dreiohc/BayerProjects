...
robocopy "%userprofile%" "D:\backup_users\%username%" /xf ntuser.dat.LOG1 /xf ntuser.dat.LOG2 /xf NTUSER.dat /xd "%userprofile%\Music" /xd "%userprofile%\AppData" /xd %userprofile%\Documents /r:0 /z /max:500100000 /copy:dat /xj /e /tee /mt:32 /log:"D:\backup_users\%username%\Backup_logs\UserProfile_Backup_log.txt" 


echo Copying Documents... 

robocopy "%userprofile%\Documents" "D:\backup_users\%username%\Documents" /z /copy:dat /xj /e /tee /mt:32 /max:500100000 /log:"D:\backup_users\%username%\Backup_logs\Documents_Backup_log.txt"


echo Copying Music... 

robocopy "%userprofile%\Music" "D:\backup_users\%username%\Music" /xj /e /tee /mt:32  /r:0 /max:500100000 /log:"D:\backup_users\%username%\Backup_logs\Music_Backup_log.txt"


echo Copying Temp Folder...


robocopy "C:\Temp" "D:\backup_users\%username%\CTemp" /xj /e /tee /mt:32  /r:0 /max:500100000 /log:"D:\backup_users\%username%\Backup_logs\Temp_Backup_log.txt"
